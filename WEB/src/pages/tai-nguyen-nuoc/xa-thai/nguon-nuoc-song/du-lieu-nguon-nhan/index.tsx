...
import NguonNuocNhan from 'src/views/receive-wastewater/lake/wastewater-source'

const DuLieuNguonNhanPage = () => {
  ...
  return hasAccess ? <NguonNuocNhan /> : <Error401 />
}

export default DuLieuNguonNhanPage
