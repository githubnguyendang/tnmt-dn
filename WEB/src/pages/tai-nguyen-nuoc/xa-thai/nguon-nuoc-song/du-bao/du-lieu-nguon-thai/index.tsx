...
import NguonThaiCLNDB from 'src/views/receive-wastewater/lake/dubao/du-lieu-nguon-thai'

const DuLieuNguonThaiPage = () => {
  ...
  return hasAccess ? <NguonThaiCLNDB /> : <Error401 />
}

export default DuLieuNguonThaiPage
