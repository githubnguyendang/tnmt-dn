...
import LakeForeCast from 'src/views/receive-wastewater/AoHo/dubao'

const RiverForeCastPage = () => {
  ...
  return hasAccess ? <LakeForeCast /> : <Error401 />
}

export default RiverForeCastPage
