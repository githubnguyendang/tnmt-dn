...
import TotalGroundWater from 'src/views/kiemketnn/nuocduoidat/luongnuocduoidat'

const TotalGroundWaterPage = () => {
  ...
  return hasAccess ? <TotalGroundWater /> : <Error401 />
}

export default TotalGroundWaterPage
