...
import QualityGroundWater from 'src/views/kiemketnn/nuocduoidat/kiem-ke-CLN-duoi-dat'

const QualityGroundWaterPage = () => {
  ...
  return hasAccess ? <QualityGroundWater /> : <Error401 />
}

export default QualityGroundWaterPage
