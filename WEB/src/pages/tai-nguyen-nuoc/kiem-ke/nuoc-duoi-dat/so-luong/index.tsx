...
import QuantityGroundWater from 'src/views/kiemketnn/nuocduoidat/so-luong-ndd'

const QuantityGroundWaterPage = () => {
  ...
  return hasAccess ? <QuantityGroundWater /> : <Error401 />
}

export default QuantityGroundWaterPage
