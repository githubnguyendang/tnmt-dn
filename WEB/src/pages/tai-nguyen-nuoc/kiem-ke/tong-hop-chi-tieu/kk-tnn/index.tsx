...
import KiemKeTNNTinh from 'src/views/kiemketnn/tong-hop-chi-tieu/kk-tnn-tinh'

const KiemKeTNNTinhPage = () => {
  ...
  return hasAccess ? <KiemKeTNNTinh /> : <Error401 />
}

export default KiemKeTNNTinhPage
