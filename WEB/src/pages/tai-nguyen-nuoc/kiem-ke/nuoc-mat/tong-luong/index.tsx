...
import TotalSFWater from 'src/views/kiemketnn/nuoc-mat/luongnuocmat'

const TotalWaterPage = () => {
  ...
  return hasAccess ? <TotalSFWater /> : <Error401 />
}

export default TotalWaterPage
