...
import ExploitOceWater from 'src/views/kiemketnn/nuoc-bien'

const ExploitOceWaterPage = () => {
  ...
  return hasAccess ? <ExploitOceWater /> : <Error401 />
}

export default ExploitOceWaterPage
