...
import LuongMuaDuBao from 'src/views/van-hanh-ho-chua/mua-du-bao/LuongMuaDuBao'

const LuongMuaDuBaoPage = () => {
  ...
  return hasAccess ? <LuongMuaDuBao /> : <Error401 />
}

export default LuongMuaDuBaoPage
