...
import VanHanhHoChuaLuuVucSong from 'src/views/van-hanh-ho-chua/du-lieu-luu-vuc'

const DuLieuLuVucPage = () => {
  ...
  return hasAccess ? <VanHanhHoChuaLuuVucSong /> : <Error401 />
}

export default DuLieuLuVucPage
