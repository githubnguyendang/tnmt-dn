...
import TomTatVanHanhLuSom from 'src/views/van-hanh-ho-chua/lu-som/tom-tat-lu-som'

const VanHanhCacHoPage = () => {
  ...
  return hasAccess ? <TomTatVanHanhLuSom /> : <Error401 />
}

export default VanHanhCacHoPage
