...
import DakdrinhhMuaLu from 'src/views/van-hanh-ho-chua/van-hanh-mua-lu/dakdinh-mua-lu'
...
const DakDriNhPage = () => {
  ...
  return hasAccess ? <DakdrinhhMuaLu /> : <Error401 />
}

export default DakDriNhPage
