...
import ThongTinHoChua from 'src/views/van-hanh-ho-chua/thong-tin-ho-chua'

const DuLieuHoChuaPage = () => {
  ...
  return hasAccess ? <ThongTinHoChua /> : <Error401 />
}

export default DuLieuHoChuaPage
