...
import TomTatVanHanhMuaLu from 'src/views/van-hanh-ho-chua/van-hanh-mua-lu/tom-tat-van-hanh'

const TomTatVanHanhPage = () => {
  ...
  return hasAccess ? <TomTatVanHanhMuaLu /> : <Error401 />
}

export default TomTatVanHanhPage
