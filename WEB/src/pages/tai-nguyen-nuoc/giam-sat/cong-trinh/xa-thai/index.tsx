...
import DischargeWaterConstruction from 'src/views/construction/dischargewater'

const DischargeWaterConstructionPage = () => {
  ...
  return hasAccess ? <DischargeWaterConstruction /> : <Error401 />
}

export default DischargeWaterConstructionPage
