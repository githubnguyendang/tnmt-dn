...
import GroundWaterConstruction from 'src/views/construction/groundwater'

const GroundWaterConstructionPage = () => {
  ...
  return hasAccess ? <GroundWaterConstruction /> : <Error401 />
}

export default GroundWaterConstructionPage
