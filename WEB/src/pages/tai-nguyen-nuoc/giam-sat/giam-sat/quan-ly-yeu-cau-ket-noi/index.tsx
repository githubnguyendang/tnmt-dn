...
import ManageRequestConnection from 'src/views/monitoring-system/manage-request'

const RequestConnectionMonitoringPage = () => {
  ...
  return hasAccess ? <ManageRequestConnection /> : <Error401 />
}

export default RequestConnectionMonitoringPage
