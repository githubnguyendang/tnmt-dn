...
import HSKTT_NuocDuoiDat from 'src/views/data-information/station-engineering/NuocDuoiDat/StationGround'

const HsktTramNuocDuoiDatPage = () => {
  ...
  return hasAccess ? <HSKTT_NuocDuoiDat /> : <Error401 />
}

export default HsktTramNuocDuoiDatPage
