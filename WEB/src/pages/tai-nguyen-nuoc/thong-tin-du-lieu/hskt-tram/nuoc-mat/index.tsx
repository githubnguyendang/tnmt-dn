...
import HSKTT_NuocMat from 'src/views/data-information/station-engineering/NuocMat/StationSuface'

const HsktTramNuocMatPage = () => {
  ...
  return hasAccess ? <HSKTT_NuocMat /> : <Error401 />
}

export default HsktTramNuocMatPage
