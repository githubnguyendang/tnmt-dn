...
import QualitySuface from 'src/views/data-information/qualitywater/QualitySF'
import BoxLoading from 'src/@core/components/box-loading'

const QualityWaterPage = () => {
  ...
  return hasAccess ? <QualitySuface /> : <Error401 />
}

export default QualityWaterPage
