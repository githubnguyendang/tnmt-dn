...
import KTSDPhaiKeKhai from 'src/views/data-information/cong-trinh-KTSD-TNN/KTSD-phai-ke-khai'
import BoxLoading from 'src/@core/components/box-loading'

const KTSDPhaiKeKhaiPage = () => {
  ...
  return hasAccess ? <KTSDPhaiKeKhai /> : <Error401 />
}

export default KTSDPhaiKeKhaiPage
