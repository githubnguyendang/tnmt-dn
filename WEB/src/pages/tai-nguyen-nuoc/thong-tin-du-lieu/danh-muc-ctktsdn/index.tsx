...
import CategoryCTKTSDN from 'src/views/data-information/category-mnnt'
import BoxLoading from 'src/@core/components/box-loading'

const DanhMucCTKTSDNPage = () => {
  ...
  return hasAccess ? <CategoryCTKTSDN /> : <Error401 />
}

export default DanhMucCTKTSDNPage
