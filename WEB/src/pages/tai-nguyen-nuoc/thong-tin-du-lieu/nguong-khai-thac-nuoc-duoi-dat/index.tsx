...
import NguongKhaiThacNuocDuoiDat from 'src/views/data-information/nguong-khai-thac-nuoc-duoi-dat'

const NguongKhaiThacNuocDuoiDatPage = () => {
  ...
  return hasAccess ? <NguongKhaiThacNuocDuoiDat /> : <Error401 />
}

export default NguongKhaiThacNuocDuoiDatPage
