...
import HoChua3Den10TrieuM3 from 'src/views/ho-chua/3-den-10trieu-m3'

const HoChua3Den10Trieu = () => {
  ...
  return hasAccess ? <HoChua3Den10TrieuM3 /> : <Error401 />
}

export default HoChua3Den10Trieu
