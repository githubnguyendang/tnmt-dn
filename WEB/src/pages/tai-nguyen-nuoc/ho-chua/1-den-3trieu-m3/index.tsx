...
import HoChua1Den3TrieuM3 from 'src/views/ho-chua/1-den-3trieu-m3'

const HoChua1Den3Trieu = () => {
  ...
  return hasAccess ? <HoChua1Den3TrieuM3 /> : <Error401 />
}

export default HoChua1Den3Trieu
