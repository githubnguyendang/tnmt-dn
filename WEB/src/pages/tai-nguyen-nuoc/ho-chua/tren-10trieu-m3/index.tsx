...
import HoChuaTren10TrieuM3 from 'src/views/ho-chua/3-den-10trieu-m3'

const HoChuaTren10Trieu = () => {
  ...
  return hasAccess ? <HoChuaTren10TrieuM3 /> : <Error401 />
}

export default HoChuaTren10Trieu
