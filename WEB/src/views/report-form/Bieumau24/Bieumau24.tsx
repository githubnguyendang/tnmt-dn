...
const FormContruction = () => {
  return (
    <Paper sx={{ p: 8 }}>
      ...
      <Grid container>
        <Grid md={11}>
          <Typography variant='h5'>Biểu mẫu số 24. Tổng hợp tình hình xả nước thải</Typography>
        </Grid>
        <Grid md={1}>
          <IconButton>
            <DownloadIcon />
            ...
            <TableHead className='tableHead'>
              <TableRow>
                ...
                <TableCell size='small' align='center' rowSpan={2}>
                  Lưu lượng xả thải <br /> được cấp phép
                  <br />
      ...
      {(openDialogs: (content: React.ReactNode, title: React.ReactNode) => void) => (
        <Box className='formReport_box' onClick={() => openDialogs(<FormContruction />, formTitle)}>
          <Grid item xs={8}>
            ...
            <Typography className='text-success text-weight-bold _font12'>Tổng hợp tình hình xả nước thải</Typography>
          </Grid>
          <Grid item xs={4}>
