...
const FormContruction = () => {
  return (
    <Paper sx={{ p: 8 }}>
      ...
      <Grid container>
        <Grid md={11}>
          <Typography variant='h5'>Biểu mẫu số 23. Tổng hợp tình hình khai thác, sử dụng nước nước dưới đất</Typography>
        </Grid>
        <Grid md={1}>
          <IconButton>
            <DownloadIcon />
            ...
            <TableHead className='tableHead'>
              <TableRow>
                ...
                <TableCell size='small' align='center' colSpan={3}>
                  Lưu lượng khai thác của giếng số ...
                  <br />
                  (m3/ngày đêm)
                </TableCell>
      ...
      {(openDialogs: (content: React.ReactNode, title: React.ReactNode) => void) => (
        <Box className='formReport_box' onClick={() => openDialogs(<FormContruction />, formTitle)}>
          <Grid item xs={8}>
            ...
            <Typography className='text-success text-weight-bold _font12'>Tổng hợp KTSD nước dưới đất</Typography>
          </Grid>
          <Grid item xs={4}>
