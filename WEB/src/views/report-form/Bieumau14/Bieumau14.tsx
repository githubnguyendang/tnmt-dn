...
const FormContruction = () => {
  ...
  const columnsTable: TableColumn[] = [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Tổng Coliform [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Nitrate [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Amoni [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Tổng chất rắn hòa tan (TDS)[-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Độ cứng(tính theo CaCO3) [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Arsenic [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Chloride [-]
        </Box>
      ),
      align: 'center',
      children: [
      ...
      {loading ? (
        ...
        <Grid className='_text_center' sx={{ mt: 3 }}>
          <Box sx={{ width: 'max-content' }}>
            <ExportTableToExcel tableId={'BieuMau14'} filename={'BieuMau14'} />
          </Box>
          <TableComponent
