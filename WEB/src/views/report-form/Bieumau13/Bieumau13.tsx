...
const FormContruction = () => {
  ...
  const columnsTable: TableColumn[] = [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu BOD5 [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu COD [-]
        </Box>
      ),
      align: 'center',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu DO [-]
        </Box>
      ),
      align: 'center',
      children: [
      ...
      {loading ? (
        ...
        <Grid className='_text_center' sx={{ mt: 3 }}>
          <Box sx={{ width: 'max-content' }}>
            <ExportTableToExcel tableId={'bieumau13'} filename={'bieumau13'} />
          </Box>
          <TableComponent
