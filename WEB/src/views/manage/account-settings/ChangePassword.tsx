    ...
    <form onSubmit={handleChangePassWord}>
      <Grid container>
        ...
        {newPassword !== confirmPassword ? (
          <Box sx={{ mb: 3 }}>
            {' '}
            <Alert sx={{ py: 0.5 }} severity='error'>
      ...
      <DialogActions sx={{ p: 0 }}>
        ...
        <Button type='submit' disabled={saving || newPassword !== confirmPassword} className='btn saveBtn'>
          {' '}
    ...
    <DialogsControl>
      {(openDialogs: (content: React.ReactNode, title: React.ReactNode) => void, closeDialogs: () => void) => (
        <Button
          ...
          onClick={() => openDialogs(<Form closeDialogs={closeDialogs} />, formTitle)}>
