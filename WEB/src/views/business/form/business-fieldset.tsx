    ...
    <Grid container spacing={4} rowSpacing={1}>
      <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
        <TextField
          ...
          required
          placeholder=''
          defaultValue={businessData?.tenTCCN}
          onChange={handleChange('tenTCCN')}
        />
      </Grid>
      <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
        <TextField
          ...
          fullWidth
          required
          defaultValue={businessData?.diaChi}
      ...
      <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
        <TextField
          ...
          fullWidth
          placeholder=''
          defaultValue={businessData?.giamDoc}
          onChange={handleChange('giamDoc')}
        />
      </Grid>
      <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
        <TextField
          ...
          fullWidth
          placeholder=''
          defaultValue={businessData?.nguoiDaiDienPhapLuat}
          onChange={handleChange('nguoiDaiDienPhapLuat')}
        />
      </Grid>
      <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
        <TextField
      ...
      <Grid item xs={12} md={12} sm={12} sx={{ my: 2 }}>
        <TextField
          ...
          fullWidth
          placeholder=''
          defaultValue={businessData?.maSoThue}
          onChange={handleChange('maSoThue')}
        />
      </Grid>
    </Grid>
  )
