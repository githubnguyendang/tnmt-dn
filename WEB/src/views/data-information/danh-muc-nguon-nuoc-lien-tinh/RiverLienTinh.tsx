    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          minWidth: 250,
          elm: (row: any) => (
            <Typography className='f_14'>{row.xaPhuongTTDiemDau == null ? '-' : row.xaPhuongTTDiemDau}</Typography>
          )
        },
        {
          id: 'huyenTPDiemDau',
          ...
          minWidth: 250,
          elm: (row: any) => (
            <Typography className='f_14'>{row.huyenTPDiemDau == null ? '-' : row.huyenTPDiemDau}</Typography>
          )
        }
      ]
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          minWidth: 150,
          elm: (row: any) => (
            <Typography className='f_14'>{row.thonDiemCuoi == null ? '-' : row.thonDiemCuoi}</Typography>
          )
        },
        {
          ...
          minWidth: 250,
          elm: (row: any) => (
            <Typography className='f_14'>{row.xaPhuongTTDiemCuoi == null ? '-' : row.xaPhuongTTDiemCuoi}</Typography>
          )
        },
        {
          id: 'huyenTPDiemCuoi',
          ...
          minWidth: 250,
          elm: (row: any) => (
            <Typography className='f_14'>{row.huyenTPDiemCuoi == null ? '-' : row.huyenTPDiemCuoi}</Typography>
          )
        }
      ]
    },
