...
import { Box, Button, Grid, Paper, SelectChangeEvent, Toolbar } from '@mui/material'
...
const QualityGround = () => {
  ...
  const columnsTable: TableColumn[] = [
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Nitrate (NO3- tính theo <br /> Nitơ) [mg/l]
        </Box>
      ),
      align: 'left',
      children: [
...

    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br /> chỉ tiêu Amoni (NH4+ tính theo <br /> Nitơ) [mg/l]
        </Box>
      ),
      align: 'left',
      children: [
    ...
    },
    {
      ...
      label: (
        <Box>
          ...
          chỉ tiêu Tổng chất rắn hòa tan <br />
          (TDS) [mg/l]
        </Box>
      ),
      align: 'left',
    ...
    },
    {
      ...
      label: (
        <Box>
          Kết quả phân tích <br />
          chỉ tiêu Độ cứng (tính theo CaCO3) [mg/l]{' '}
        </Box>
      ),
      align: 'left',
      children: [
