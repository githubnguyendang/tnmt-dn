...
const MuaNgayTram = () => {
  ...
  const Bangmuangaytram: TableColumn[] = [
    {
      id: 'stt',
      label: 'STT'
    },
    ...
    {
        id: '#',
        label: 'Tọa độ (VN2000,  108o múi chiếu 3o)',
        align: 'left',
        children: [
          {
            id: '#4',
...
<Typography className='font-weight-bold ' variant='h6'>
  Số liệu mưa ngày tại trạm đo mưa
</Typography>
...
<Grid className='_text_center' sx={{ mt: 3 }}>
  ...
  <RainWaterToolBar onExport={{ data: data, column: Bangmuangaytram }} />
  <TableComponent
    columns={Bangmuangaytram}
    rows={data}
    loading={loading}
    pagination
    actions={(row: any) => (
