...
const Mualuuvuc = () => {
  ...
  const Bangmualuuvuc: TableColumn[] = [
    {
      id: 'stt',
      label: 'STT'
    },
...
<Typography className='font-weight-bold ' variant='h6'>
  Tổng lượng mưa phân bố theo lưu vực sông
</Typography>
<Typography className='font-weight-bold ' variant='h6'>
  (Kỳ báo cáo:{' '}
...
<Grid className='_text_center' sx={{ mt: 3 }}>
  ...
  <RainWaterToolBar onExport={{ data: data, column: Bangmualuuvuc }} />
  <TableComponent
    columns={Bangmualuuvuc}
    rows={data}
    loading={loading}
    pagination
    actions={(row: any) => (
