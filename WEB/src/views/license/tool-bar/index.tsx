...
const LicenseToolBar: FC<LicenseToolBarProps> = ({ onChange, onExport }) => {
  ...
  return (
    <Toolbar variant='dense'>
      <form onSubmit={applyFilterChange}>
        <Grid container spacing={2} sx={{ paddingY: 3 }}>
          ...
          router.pathname.split('/')[4] == 'xa-thai' ? (
            <Grid item xs={12} md={3} py={0}>
              <TextField
                ...
                onChange={(e: any) => handleChange(e)('cong_trinh')}
              />
            </Grid>
          ) : (
            ''
          ...
          <Grid item xs={12} md={2} py={0}>
            <FormControl size='small' fullWidth>
              ...
              <Select
                ...
                <MenuItem value=''>Cơ quan cấp phép</MenuItem>
          ...
          <Grid item xs={12} md={2} py={0}>
            <FormControl size='small' fullWidth>
              ...
              <Select
                ...
                <MenuItem value={0}>Loại hình cấp phép</MenuItem>
          ...
          <Grid item xs={12} md={2} py={0}>
            <FormControl size='small' fullWidth>
              ...
              <Select
                ...
                <MenuItem value=''>Hiệu lực giấy phép</MenuItem>
          ...
          <Grid item xs={12} md={12}>
            <Collapse in={open}>
              <fieldset>
                <legend>
                  <Typography variant={'subtitle1'}>Tìm kiếm nâng cao</Typography>
                </legend>
                <Grid container spacing={2}>
                  <Grid item xs={12} md={2} py={0}>
                    <Autocomplete
                      ...
                      clearOnEscape={true}
                      renderInput={params => <TextField {...params} label='TC/Cá nhân được CP' variant='outlined' />}
                    />
                  </Grid>
                  <Grid item xs={12} md={2} py={0}>
                    <Autocomplete
                      ...
                      clearOnEscape={true}
                      renderInput={params => <TextField {...params} label='Huyện' variant='outlined' />}
                    />
                  </Grid>
                  <Grid item xs={12} md={2} py={0}>
                    <Autocomplete
                      ...
                      clearOnEscape={true}
                      renderInput={params => <TextField {...params} label='Xã' variant='outlined' />}
                    />
                  </Grid>
                  <Grid item xs={12} md={2} py={0}>
                    <Autocomplete
                      ...
                      clearOnEscape={true}
                      renderInput={params => <TextField {...params} label='Tiểu vùng quy hoạch' variant='outlined' />}
                    />
                  </Grid>
                  <Grid item xs={12} md={2} py={0}>
          ...
          <Grid item xs={6} md={1.5} py={0}>
            <Button variant='outlined' type='submit' size='small' fullWidth startIcon={<Search />}>
              Tìm kiếm
            </Button>
          </Grid>
          <Grid item xs={6} md={1.5} py={0}>
          ...
          {(router.pathname.split('/')[4] && router.pathname.split('/')[4] == 'nuoc-mat') ||
          router.pathname.split('/')[4] == 'nuoc-duoi-dat' ||
          router.pathname.split('/')[4] == 'xa-thai' ? (
            <Grid item xs={6} md={1.5} py={0}>
