...
import ApexChartLicense, { RechartLicenseProps } from 'src/views/license/license-bar-chart'
...
const ManageLicense = () => {
  ...
  const [dataForChart, setDataForChart] = useState<RechartLicenseProps>({ series: [], year: [], color: [] })
      ...
      <Grid xs={12} sm={12} md={12}>
        <Paper elevation={3}>
          ...
          {loading ? (
            ...
            <ApexChartLicense series={dataForChart.series} year={dataForChart.year} color={dataForChart.color} />
          )}
        </Paper>
      </Grid>
    </Grid>
