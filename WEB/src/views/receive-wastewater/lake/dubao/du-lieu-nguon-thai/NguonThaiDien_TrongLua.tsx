...
const NguonThaiTrongLua = () => {
  ...
  useEffect(() => {
    async function getDataReport1() {
      setLoading(true)
      await getData('DuLieuNguonNuocThaiTrongLuaDB/danh-sach')
        .then(data => {
          setData(data)
        })
        .catch(error => {
