...
const NguonThaiDien_TrongCay = () => {
  ...
  useEffect(() => {
    async function getDataReport1() {
      setLoading(true)
      await getData('DuLieuNguonNuocThaiTrongCayDB/danh-sach')
        .then(data => {
          setData(data)
        })
        .catch(error => {
