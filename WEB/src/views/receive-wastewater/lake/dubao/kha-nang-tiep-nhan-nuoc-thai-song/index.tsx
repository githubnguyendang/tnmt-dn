...
const KhaNangTiepNhanNuocThaiSongDB = () => {
  ...
  const columnsTable: TableColumn[] = [
    ...
    { id: 'heSoFS', label: 'Hệ số an toàn(Fs)', rowspan: 2, align: 'left' },
    {
      ...
      align: 'left',
      children: [
        { id: 'ltnBod', label: 'BOD5 (mg/l)', align: 'left', elm: (row: any) => FormatCellValue(row.ltnBodDB) },
        { id: 'ltnCod', label: 'COD (mg/l)', align: 'left', elm: (row: any) => FormatCellValue(row.ltnCodDB) },
        { id: 'ltnAmoni', label: 'Amoni (mg/l)', align: 'left', elm: (row: any) => FormatCellValue(row.ltnAmoniDB) },
        { id: 'ltnTongN', label: 'Tổng N (mg/l)', align: 'left', elm: (row: any) => FormatCellValue(row.ltnTongNDB) },
        { id: 'ltnTongP', label: 'Tổng P (mg/l)', align: 'left', elm: (row: any) => FormatCellValue(row.ltnTongPDB) },
        {
          id: 'ltnTSS',
          label: 'Tổng chất rắn lơ lửng TSS (mg/l)',
          align: 'left',
          elm: (row: any) => FormatCellValue(row.ltnTSSDB)
        },
        {
          id: 'ltnColiform',
          label: 'Tổng Coliform (MPN/100ml)',
          align: 'left',
          elm: (row: any) => FormatCellValue(row.ltnColiformDB)
        }
      ]
    },
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid item xs={12}>
        ...
        <ToolBar onChange={handleFilterChange} tabId='aa'/>
...
export default KhaNangTiepNhanNuocThaiSongDB
