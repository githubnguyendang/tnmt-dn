...
interface ThanhCongCuQuanTracProps {
  onChange: (data: any, postSuccess?: boolean | undefined) => void
}
const ThanhCongCuQuanTrac: FC<ThanhCongCuQuanTracProps> = ({ onChange }) => {
          ...
          setConsTypes(
            ConsTypesData.map((item: any) => {
              ...
              switch (section) {
                ...
                default:
                  const children =
                    item.parentId === 0 ? ConsTypesData.filter((childItem: any) => childItem.parentId === item.id) : []
...
export default ThanhCongCuQuanTrac
