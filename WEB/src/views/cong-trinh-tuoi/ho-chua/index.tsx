...
import ThanhCongCuGiamSat from './thanh_cong_cu'
import HeThongGiamSatDuLieuView from './form'
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid item xs={12} sm={12} md={12}>
        <ThanhCongCuGiamSat onChange={handleFilterChange} />
        <TableComponent
          loading={loading}
          columns={columns}
          rows={dataFiltered}
          ...
          actions={row => (
            <Box>
              <HeThongGiamSatDuLieuView data={row} />
            </Box>
          )}
        />
      </Grid>
