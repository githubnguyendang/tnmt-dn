...
import { Box, Button, CircularProgress, DialogActions, Grid, IconButton, Tooltip } from '@mui/material'
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <DialogActions sx={{ p: 0, mt: 5 }}>
        <Button startIcon={<Cancel />} variant='outlined' color='error' size='small' onClick={handleClose}>
          Huỷ
        </Button>
        <Button
