...
const Detail = () => {
  const loading = false
  const timeSlots = ['00h', '01h','02h','03h', '04h','05h','06h', '07h','08h','09h', '10h','11h','12h', '13h','14h','15h', '16h','17h','18h', '19h','20h','21h','22h','23h']
  ...
  const columnsTableDetail: TableColumn[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { id: '01h', label: '01h', align: 'center' },
        { id: '02h', label: '02h', align: 'center' },
        { id: '03h', label: '03h', align: 'center' },
        { id: '04h', label: '04h', align: 'center' },
        { id: '05h', label: '05h', align: 'center' },
        { id: '06h', label: '06h', align: 'center' },
        { id: '07h', label: '07h', align: 'center' },
        { id: '08h', label: '08h', align: 'center' },
