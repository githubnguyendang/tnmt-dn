...
const DischargeConstruction = () => {
  ...
  const columnsTable: TableColumn[] = [
    ...
    {
      id: 'nguonNuocXT',
      label: 'Nguồn tiếp nhận nước thải',
      align: 'left',
      minWidth: 300,
      elm: (row: any) => row.thongso?.nguonNuocXT
    },
    {
      id: 'phuongThucXT',
      label: 'Phương thức xả nước thải',
      align: 'left',
      minWidth: 300,
      elm: (row: any) => row.thongso?.phuongThucXT
    },
    {
      id: 'cheDoXT',
      label: 'Chế độ xả nước thải',
      align: 'left',
      minWidth: 300,
      elm: (row: any) => row.thongso?.cheDoXT
    },
