...
import { Grid, Button, TextField, DialogActions, Autocomplete, Box } from '@mui/material'
      ...
      <Grid container>
        ...
        <Grid item xs={12} md={12} sx={{ my: 2 }}>
          <Autocomplete
            ...
            options={complete1}
            getOptionLabel={option => option.title}
            renderInput={params => <TextField {...params} variant='outlined' label='Chọn cơ quan GP' placeholder='' />}
          />
        </Grid>
        <Grid item xs={12} md={12} sx={{ my: 2 }}>
          <Autocomplete
            ...
            options={complete1}
            getOptionLabel={option => option.title}
            renderInput={params => <TextField {...params} variant='outlined' label='Chọn huyện' placeholder='' />}
          />
        </Grid>
        <Grid item xs={12} md={12} sx={{ my: 2 }}>
          <Autocomplete
      ...
      {(openDialogs: (content: React.ReactNode, title: React.ReactNode) => void, closeDialogs: () => void) => (
        <Box>
          <Button
            ...
            variant='outlined'
            onClick={() => openDialogs(<Form onSubmit={handleSubmit} closeDialogs={closeDialogs} />, formTitle)}>
            Bộ lọc
          </Button>
        </Box>
      )}
