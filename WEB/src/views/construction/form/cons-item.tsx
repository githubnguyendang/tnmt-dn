...
const ConstructionItem: FC<ConstructionItemFieldProps> = ({ data, type, onChange }) => {
  const [constructionItems, setConstructionItems] = useState<ConstructionItemState[]>([])
  ...
  const handleChange = (prop: keyof ConstructionItemState | keyof ConstructionSpecState) => (value: any) => {
    setNewConsItem(prevItem => {
      ...
      } else if (newItem.thongso) {
        newItem.thongso = { ...newItem.thongso, [prop]: value, daXoa: false }
      } else {
        newItem.thongso = { id: null, idCT: null, idHangMucCT: null, daXoa: false, [prop]: value }
      }
  ...
  const handleOpenModal = (index: number, e: any, func: 'add' | 'update') => {
    ...
    if (func === 'add') {
      ...
      const nullThongso = Object.fromEntries(Object.keys(newConsItem.thongso || {}).map(key => [key, null]))
      ...
      setNewConsItem({
        ...
        y: null,
        daXoa: false,
        thongso: { ...nullThongso, id: null, idCT: null, idHangMucCT: null }
      })
    }
  ...
  const handleSave = () => {
    if (newConsItem.tenHangMuc && newConsItem.tenHangMuc !== null && newConsItem.tenHangMuc !== '') {
      if (newConsItemIndex >= 0) {
        ...
        setConstructionItems(prevItems => {
          const updatedItems = [...prevItems, newConsItem]
                              ...
                              <Box>
                                ...
                                <Grid item md={12}>
                                  <TextField
                                    ...
                                    size='small'
                                    value={
                                      newConsItem.thongso?.hDoanThuNuocTu == null
                                        ? ''
                                        : newConsItem.thongso?.hDoanThuNuocTu
                                    }
                                ...
                                <Grid item md={12}>
                                  <TextField
                                    ...
                                    size='small'
                                    value={
                                      newConsItem.thongso?.hDoanThuNuocDen == null
                                        ? ''
                                        : newConsItem.thongso?.hDoanThuNuocDen
                                    }
                                ...
                                <Grid item md={12}>
                                  <TextField
                                    ...
                                    size='small'
                                    value={
                                      newConsItem.thongso?.hDatOngLocTu == null ? '' : newConsItem.thongso?.hDatOngLocTu
                                    }
                                ...
                                <Grid item md={12}>
                                  <TextField
                                    ...
                                    size='small'
                                    value={
                                      newConsItem.thongso?.hDatOngLocDen == null
                                        ? ''
                                        : newConsItem.thongso?.hDatOngLocDen
                                    }
                            ...
                            <Box>
                              ...
                              <Grid item md={12}>
                                <TextField
                                  ...
                                  size='small'
                                  value={
                                    newConsItem.thongso?.phuongThucXT == null ? '' : newConsItem.thongso?.phuongThucXT
                                  }
                              ...
                              <Grid item md={12}>
                                <TextField
                                  ...
                                  size='small'
                                  value={
                                    newConsItem.thongso?.nguonNuocXT == null ? '' : newConsItem.thongso?.nguonNuocXT
                                  }
            ...
            {constructionItems
              ...
              .map((item, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell padding='checkbox'>{item.tenHangMuc}</TableCell>
                  <TableCell padding='checkbox'>{item.x}</TableCell>
                  <TableCell padding='checkbox'>{item.y}</TableCell>
                  {type == 2 || type == 7 ? <TableCell padding='checkbox'>{item.thongso?.qKhaiThac}</TableCell> : ''}
                  {type == 2 || type == 7 ? <TableCell padding='checkbox'>{item.thongso?.cheDoKT}</TableCell> : ''}
                  {type == 2 || type == 7 ? (
                    <TableCell padding='checkbox'>{item.thongso?.hDoanThuNuocTu}</TableCell>
                  ) : (
                    ''
                  )}
                  {type == 2 || type == 7 ? (
                    <TableCell padding='checkbox'>{item.thongso?.hDoanThuNuocDen}</TableCell>
                  ) : (
                    ''
                  )}
                  {type == 2 || type == 7 ? <TableCell padding='checkbox'>{item.thongso?.hTinh}</TableCell> : ''}
                  {type == 2 || type == 7 ? <TableCell padding='checkbox'>{item.thongso?.hDong}</TableCell> : ''}
                  {type == 2 || type == 7 ? <TableCell padding='checkbox'>{item.thongso?.hDatOngLocTu}</TableCell> : ''}
                  {type == 2 || type == 7 ? (
                    <TableCell padding='checkbox'>{item.thongso?.hDatOngLocDen}</TableCell>
                  ) : (
                    ''
                  )}
                  {type == 3 ? <TableCell padding='checkbox'>{item.viTriHangMuc}</TableCell> : ''}
                  {type == 3 ? <TableCell padding='checkbox'>{item.thongso?.nguonNuocXT}</TableCell> : ''}
                  {type == 3 ? <TableCell padding='checkbox'>{item.thongso?.phuongThucXT}</TableCell> : ''}
                  {type == 3 ? <TableCell padding='checkbox'>{item.thongso?.cheDoXT}</TableCell> : ''}
                  {type == 3 ? <TableCell padding='checkbox'>{item.thongso?.qXaThai}</TableCell> : ''}
