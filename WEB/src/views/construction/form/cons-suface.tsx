...
const SurfaceWaterField: FC<ConsTypeFieldsetProps> = ({ props, onChange }) => {
    ...
    const getDataConstruction = async () => {
      ...
      try {
        if (props !== undefined) {
          ...
          setSelectedDistricts(cons.vitri.map((location: any) => `${location.tenHuyen}-${location.idHuyen}`))
          setSelectedCommunes(
            cons.vitri.map((location: any) => `${location.tenXa}-${location.idXa}-${location.idHuyen}`)
          )
        } else {
          setConstruction({})
        }
  ...
  const handleChange = (property: string) => (value: any) => {
    setConstruction(prev => {
      const newState = {
        ...prev,
        maCT: createConsCode({ ...prev, [property]: value }),
        taiKhoan: createConsUser({ ...prev, [property]: value })
      }
    ...
    <Box>
      <fieldset>
        ...
        <Grid container spacing={6} mb={4}>
            ...
            <Grid item xs={12} md={3} sm={12}>
              <Autocomplete
                ...
                getOptionLabel={(option: any) =>
                  option.tenCT !== null
                    ? `${option.tenCT} ${option.huyen !== null ? `(${option.huyen?.map((e: any) => e.tenHuyen)})` : ''}`
                    : ''
                }
                value={
                  ds_congtrinh.find(
                    (option: any) => option.tenCT?.toLowerCase() === construction?.tenCT?.toLowerCase()
                  ) || null
                }
          ...
          {isLicensepage ? (
            <Grid item xs={12} md={3} sm={12}>
              <Button variant='outlined' size='small' startIcon={<Add />} onClick={handleAddNewCons}>
                Thêm công trình mới
              </Button>
            </Grid>
          ) : (
          ...
          <Grid container spacing={6}>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  {districts.map((dict: any) => (
                    <MenuItem key={dict.idHuyen} value={`${dict.tenHuyen}-${dict.idHuyen}`}>
                      {dict.tenHuyen}
                    </MenuItem>
                  ))}
                </Select>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  {filteredCommunes.map((comn: any) => (
                    <MenuItem key={comn.idXa} value={`${comn.tenXa}-${comn.idXa}-${comn.idHuyen}`}>
                      {comn.tenXa}
                    </MenuItem>
                  ))}
                </Select>
            ...
            <Grid item xs={12} md={3} sm={12}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  handleChange('namBatDauVanHanh')(event.target.value)
                }
              />
            </Grid>
            <Grid item xs={12} md={3} sm={12}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  handleChange('thoiGianXD')(event.target.value)
                }
              />
            </Grid>
            <Grid item xs={12} md={3} sm={12}>
            ...
            <Grid item xs={12} md={12} sm={12}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  handleChange('nguonNuocKT')(event.target.value)
                }
            ...
            <Grid item xs={12} md={12} sm={12}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  handleChange('phuongThucKT')(event.target.value)
                }
            ...
            <Grid item xs={12} md={12} sm={12}>
              <TextField
                ...
                onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                  handleChange('thongso.cheDoKT')(event.target.value)
                }
              ...
              <Grid container spacing={6}>
                ...
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.dienTichLuuVuc')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.muaTrungBinhNam')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.qTrungBinhNam')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.congSuatLM')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.congSuatDamBao')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.chieuCaoDap')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.qMaxKT')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.qtt')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.qDamBao')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.hmax')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.hmin')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.htoiThieu')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.dungTichToanBo')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.dungTichChet')(event.target.value)
                    }
                  />
                </Grid>
                <Grid item xs={12} md={3} sm={12}>
                  <TextField
                    ...
                    onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                      handleChange('thongso.dungTichHuuIch')(event.target.value)
                    }
                  />
                </Grid>
                {construction?.idLoaiCT === 4 ? (
                  <Grid item xs={12} md={3} sm={12}>
                    <TextField
                      ...
                      onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                        handleChange('thongso.mnc')(event.target.value)
                      }
                    />
                  </Grid>
                ) : (
                ...
                {construction?.idLoaiCT === 4 ? (
                  <Grid item xs={12} md={3} sm={12}>
                    <TextField
                      ...
                      onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                        handleChange('thongso.mndbt')(event.target.value)
                      }
                    />
                  </Grid>
                ) : (
                ...
                {construction?.idLoaiCT === 4 ? (
                  <Grid item xs={12} md={3} sm={12}>
                    <TextField
                      ...
                      onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                        handleChange('thongso.mnltk')(event.target.value)
                      }
                    />
                  </Grid>
                ) : (
                ...
                {construction?.idLoaiCT === 4 ? (
                  <Grid item xs={12} md={3} sm={12}>
                    <TextField
                      ...
                      onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                        handleChange('thongso.mnlkt')(event.target.value)
                      }
                    />
                  </Grid>
                ) : (
            ...
            <Grid container spacing={6}>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.soLuongMayBom')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.dienTichTuoiThietKe')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.dienTichTuoiThucTe')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.qThietKe')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.qThucTe')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.qBomThietKe')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.qBomLonNhat')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.hBeHut')(event.target.value)
                  }
                />
              </Grid>
            </Grid>
            ...
            <Grid container spacing={6}>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.caoTrinhCong')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.chieuDaiCong')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.duongKinhCong')(event.target.value)
                  }
                />
              </Grid>
              <Grid item xs={12} md={3} sm={12}>
                <TextField
                  ...
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
                    handleChange('thongso.kichThuocCong')(event.target.value)
                  }
                />
              </Grid>
            </Grid>
      ...
      {showDataCons ? (
        <Grid item xs={12}>
          {isLicensepage ? (
            <MiningPurpose
              data={construction?.luuluong_theomd || []}
              type={GetConstructionTypeId(router)}
              onChange={handleMiningPurposeChange}
            />
          ) : (
            ''
          )}
          <ConstructionItem
            data={construction?.hangmuc || []}
            type={GetConstructionTypeId(router)}
            onChange={handleConsItemChange}
          />
        </Grid>
      ) : (
        ''
